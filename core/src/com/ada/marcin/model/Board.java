...
//    private final List<Ship> ships = new ArrayList<Ship>();
    ...
    public static final Logger logger = new Logger(Board.class.getName(), Logger.DEBUG);
    ...
    private boolean isPlacementAllowed(List<Coordinate> coordinates){
        ...
        if(direction==Direction.Horizontal){
            ...
            for(Coordinate coordinate : coordinates){
               ...
               xMin= Math.min(myX, xMin);
               xMax= Math.max(myX, xMax);
            ...
            for(Coordinate coordinate : coordinates){
                ...
                yMin= Math.min(myY, yMin);
                yMax= Math.max(myY, yMax);
 ...
 //   }
    ...
    public boolean placeShipOnTheGrid(ShipView shipView) {
        ...
        for(Coordinate coordinate : shipView.getCoordinates()){
            ...
            board.put(coordinate,new CellContent(shipView.getShipType(),index,false));
            index--;
